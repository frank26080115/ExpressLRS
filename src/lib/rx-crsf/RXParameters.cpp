...
static selectionParameter luaSerialProtocol = {
    ...
    0, // value
    "CRSF;Inverted CRSF;SBUS;Inverted SBUS;SUMD;DJI RS Pro;HoTT Telemetry;MAVLink;DisplayPort;GPS;VESC;AM32KISS",
    STR_EMPTYSPACE
};
...
static selectionParameter luaSerial1Protocol = {
    ...
    0, // value
    "Off;CRSF;Inverted CRSF;SBUS;Inverted SBUS;SUMD;DJI RS Pro;HoTT Telemetry;Tramp;SmartAudio;DisplayPort;GPS;VESC;AM32KISS",
    STR_EMPTYSPACE
};
#endif
