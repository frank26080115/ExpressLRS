...
Bluepad32Driver Radio;

// Placeholder rate data for the RX state machine while Bluepad32 owns the real input path.
expresslrs_mod_settings_s ExpressLRS_AirRateConfig[RATE_MAX] = {
    {0, RADIO_TYPE_SX128x_LORA, RATE_LORA_2G4_50HZ, 0, 0, 0, 0, TLM_RATIO_NO_TLM, 0, 20000, OTA4_PACKET_SIZE, 1},
    {1, RADIO_TYPE_SX128x_LORA, RATE_LORA_2G4_50HZ, 0, 0, 0, 0, TLM_RATIO_NO_TLM, 0, 20000, OTA4_PACKET_SIZE, 1},
    {2, RADIO_TYPE_SX128x_LORA, RATE_LORA_2G4_50HZ, 0, 0, 0, 0, TLM_RATIO_NO_TLM, 0, 20000, OTA4_PACKET_SIZE, 1},
    {3, RADIO_TYPE_SX128x_LORA, RATE_LORA_2G4_50HZ, 0, 0, 0, 0, TLM_RATIO_NO_TLM, 0, 20000, OTA4_PACKET_SIZE, 1},
    {4, RADIO_TYPE_SX128x_LORA, RATE_LORA_2G4_50HZ, 0, 0, 0, 0, TLM_RATIO_NO_TLM, 0, 20000, OTA4_PACKET_SIZE, 1},
    {5, RADIO_TYPE_SX128x_LORA, RATE_LORA_2G4_50HZ, 0, 0, 0, 0, TLM_RATIO_NO_TLM, 0, 20000, OTA4_PACKET_SIZE, 1},
    {6, RADIO_TYPE_SX128x_LORA, RATE_LORA_2G4_50HZ, 0, 0, 0, 0, TLM_RATIO_NO_TLM, 0, 20000, OTA4_PACKET_SIZE, 1},
    {7, RADIO_TYPE_SX128x_LORA, RATE_LORA_2G4_50HZ, 0, 0, 0, 0, TLM_RATIO_NO_TLM, 0, 20000, OTA4_PACKET_SIZE, 1},
    {8, RADIO_TYPE_SX128x_LORA, RATE_LORA_2G4_50HZ, 0, 0, 0, 0, TLM_RATIO_NO_TLM, 0, 20000, OTA4_PACKET_SIZE, 1},
    {9, RADIO_TYPE_SX128x_LORA, RATE_LORA_2G4_50HZ, 0, 0, 0, 0, TLM_RATIO_NO_TLM, 0, 20000, OTA4_PACKET_SIZE, 1}};

expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
    {0, DYNPOWER_SNR_THRESH_NONE, 0, 1000, 1000, 0, 0, DYNPOWER_SNR_THRESH_NONE, DYNPOWER_SNR_THRESH_NONE},
    {1, DYNPOWER_SNR_THRESH_NONE, 0, 1000, 1000, 0, 0, DYNPOWER_SNR_THRESH_NONE, DYNPOWER_SNR_THRESH_NONE},
    {2, DYNPOWER_SNR_THRESH_NONE, 0, 1000, 1000, 0, 0, DYNPOWER_SNR_THRESH_NONE, DYNPOWER_SNR_THRESH_NONE},
    {3, DYNPOWER_SNR_THRESH_NONE, 0, 1000, 1000, 0, 0, DYNPOWER_SNR_THRESH_NONE, DYNPOWER_SNR_THRESH_NONE},
    {4, DYNPOWER_SNR_THRESH_NONE, 0, 1000, 1000, 0, 0, DYNPOWER_SNR_THRESH_NONE, DYNPOWER_SNR_THRESH_NONE},
    {5, DYNPOWER_SNR_THRESH_NONE, 0, 1000, 1000, 0, 0, DYNPOWER_SNR_THRESH_NONE, DYNPOWER_SNR_THRESH_NONE},
    {6, DYNPOWER_SNR_THRESH_NONE, 0, 1000, 1000, 0, 0, DYNPOWER_SNR_THRESH_NONE, DYNPOWER_SNR_THRESH_NONE},
    {7, DYNPOWER_SNR_THRESH_NONE, 0, 1000, 1000, 0, 0, DYNPOWER_SNR_THRESH_NONE, DYNPOWER_SNR_THRESH_NONE},
    {8, DYNPOWER_SNR_THRESH_NONE, 0, 1000, 1000, 0, 0, DYNPOWER_SNR_THRESH_NONE, DYNPOWER_SNR_THRESH_NONE},
    {9, DYNPOWER_SNR_THRESH_NONE, 0, 1000, 1000, 0, 0, DYNPOWER_SNR_THRESH_NONE, DYNPOWER_SNR_THRESH_NONE}};
#endif
