...
/*
please refer to https://mintlify.wiki/vedderb/bldc/communication/uart-protocol
and also https://github.com/vedderb/bldc/blob/master/comm/commands.c
*/

class SerialVESC : public SerialIO {
public:
    explicit SerialVESC(Stream &out, Stream &in) : SerialIO(&out, &in) { }
    virtual ~SerialVESC() {}
